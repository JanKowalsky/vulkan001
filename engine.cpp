...
InputManager& VulkanEngine::getInputManager()
{
	return m_scene->getInputManager();
}
...
void VulkanEngine::run()
{
	...
	while (m_running)
	{
		if(!m_window->manageEvents(m_scene->getInputManager()))
		{
...
bool VulkanEngine::InitSurface()
{
	...
	surface_create_info.hwnd = m_window->getParams().hwnd;
...
bool VulkanEngine::InitSurface()
{
	...
	surface_create_info.connection = m_window->getParams().connection;
	surface_create_info.window = m_window->getParams().window;
